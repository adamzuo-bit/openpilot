...
class Setup(Widget):
  ...
  def _download_thread(self):
    try:
      ...
      if not is_elf:
        self._download_failed_reason = tr("No custom software found at this URL: ") + self.download_url.replace("https://", "", 1)
        return
      ...
      self._download_failed_reason = tr("Invalid URL: ") + self.download_url.replace("https://", "", 1)
