...
---
硬性约束（必须遵守）：
- 只修改当前 openpilot 仓库源码，使上述 CI 验证通过
- 不要创建新分支，不要 git push，不要开 Pull Request
- 保留 C3 构建、release/ci/、sunnypilot/ C3 适配、ai/ 子模块；F4/H7 固件统一来自 panda/
- .gitmodules 中 opendbc/panda 保持指向 mouxangithub fork 的 master-c3
